<li class="accordion-row">		
	<div id="readings-and-resources" class="accordion-header">
		<div class="icon readings-icon"></div>
		<div class="title">Resources &amp; Readings</div>
...
</li> <!- end readings and resources row -->